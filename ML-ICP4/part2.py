...
#Bayes
#setting bayes = to GaussianNB()
bayes = GaussianNB()
#fitting X_train and Y_train data to bayes
bayes.fit(X_train,Y_train)
Y_pred=bayes.predict(X_test)
#calculating bayes score
acc_baye = round(bayes.score(X_train, Y_train)*100,2)
#output
print ("Bayes Score: ", acc_baye)
